...
export const THEMES = {
  midnight: {
    ...
    colors: {
      ...
      canvas: {
        surface: '#161618',
        card: 'rgba(40, 42, 46, 0.72)',
        cardTitleBar: 'rgba(34, 36, 40, 0.78)',
        cardBorder: 'color-mix(in srgb, white 8%, transparent)',
        textHeading: '#e8e8e8',
  ...
  slate: {
    ...
    colors: {
      ...
      canvas: {
        surface: '#141c2a',
        card: 'rgba(36, 50, 68, 0.72)',
        cardTitleBar: 'rgba(30, 42, 58, 0.78)',
        cardBorder: 'color-mix(in srgb, white 8%, transparent)',
        textHeading: '#e2e8f0',
  ...
  obsidian: {
    ...
    colors: {
      ...
      canvas: {
        surface: '#1a1a1a',
        card: 'rgba(42, 42, 44, 0.72)',
        cardTitleBar: 'rgba(36, 36, 38, 0.78)',
        cardBorder: 'color-mix(in srgb, white 8%, transparent)',
        textHeading: '#e0e0e0',
  ...
  nord: {
    ...
    colors: {
      ...
      canvas: {
        surface: '#2c3340',
        card: 'rgba(54, 62, 74, 0.72)',
        cardTitleBar: 'rgba(48, 56, 66, 0.78)',
        cardBorder: 'color-mix(in srgb, white 8%, transparent)',
        textHeading: '#eceff4',
  ...
  evergreen: {
    ...
    colors: {
      ...
      canvas: {
        surface: '#0e0e10',
        card: 'rgba(26, 26, 30, 0.72)',
        cardTitleBar: 'rgba(20, 20, 24, 0.78)',
        cardBorder: 'color-mix(in srgb, white 8%, transparent)',
        textHeading: '#e6e8ec',
  ...
  light: {
    ...
    colors: {
      ...
      canvas: {
        ...
        cardTitleBar: 'rgba(244, 248, 252, 0.90)',
